# Docker for Node
This is a boiler plate I use when developing Node apps using Docker.  It tries to have good defaults for both development and production.  It took some time to create this workflow but I think it is pretty usable.  If you find any issues or something you think could be better, don’t hesitate to let me know.
...
### Other Resources
 - email me at jose@blindpenguincode.com
